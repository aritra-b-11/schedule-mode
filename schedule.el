...
(defvar schedule-table-name "#+NAME: schedule" "Name of schedule table.")
(defvar schedule-owner-table-name "#+NAME: owner" "Name of owner table.")
(defvar schedule-effort-table-name "#+NAME: effort" "Name of effort table.")
